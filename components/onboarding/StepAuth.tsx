  ...
  return (
    <section className="flex min-h-screen items-center justify-center px-6 py-24">
      ...
      >
        ...
        {needsConfirmation ? (
          <div className="text-sm text-text border border-line rounded-sharp px-4 py-4">
            <p className="font-medium mb-1">Check your email</p>
            <p className="text-muted">
              We sent a confirmation link to finish creating your account. Once confirmed, come
              back and log in.
            </p>
          </div>
        ) : mode === "register" ? (
